...
const templates = [
  ...
  {
    id: "paymentProofFailed",
    name: "Proof of Payment Could Not Be Verified",
    category: "Payments",
    subject: "Action Required: Your Proof of Payment Could Not Be Verified — RIQS",
    description: "Sent when the Secretariat rejects a manually-uploaded proof of payment (bank transfer or other method) for a Processing Fee.",
    body: `<div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 600px; margin: 0 auto; padding: 25px; border: 1px solid #e2e8f0; border-radius: 12px; background-color: #ffffff; box-shadow: 0 4px 6px rgba(0,0,0,0.02);">
  ...
  {
    // Previously seeded but never actually wired to any code path, with fabricated mentor
    // details (a fake name/reg number) hardcoded straight into the body instead of real
    // {{}} variables — fixed here and now sent for real from adminController.ts's
    // assignMentorToApplication/autoAssignGraduateMentors whenever an Admin explicitly
    // assigns or changes a graduate's mentor.
    id: "mentorship-assign",
    name: "Mentorship Assignment",
    category: "Mentorship",
    subject: "RIQS Mentorship Programme — Mentor Assignment Confirmation",
    description: "Sent to a graduate when an Admin assigns or changes their mentor.",
    body: `<p class="mb-4">Dear <strong>{{name}}</strong>,</p>\n<p class="mb-4">We are pleased to inform you that you have been assigned a <strong>Professional Mentor</strong> under the RIQS Mentorship Programme.</p>\n<p class="mb-4"><strong>Your Assigned Mentor:</strong></p>\n<ul class="list-disc pl-5 mb-4 space-y-2">\n  <li><strong>Name:</strong> {{mentorName}}</li>\n  <li><strong>Registration ID:</strong> {{mentorRegistrationNumber}}</li>\n</ul>\n<p class="mb-4">Your mentor will guide you through the practical experience requirements needed for advancement. You are expected to:</p>\n<ol class="list-decimal pl-5 mb-4 space-y-2">\n  <li>Maintain a <strong>structured logbook</strong> of professional activities</li>\n  <li>Stay in regular contact with your mentor</li>\n  <li>Submit your <strong>Annual Report</strong> each year through the Members Portal</li>\n</ol>\n<p class="mb-4">If you have any questions, please contact the RIQS Secretariat.</p>\n<p class="mb-4">Best wishes,<br/><strong>RIQS Mentorship Committee</strong><br/>Rwanda Institute of Quantity Surveyors</p>`,
  },
  {
    // Sent to the MENTOR side of the same assignment/change — new, previously nothing
    // notified the mentor at all when a mentee landed on their list.
    id: "mentor_new_mentee_assigned",
    name: "New Mentee Assigned",
    category: "Mentorship",
    subject: "RIQS Mentorship Programme — You Have a New Mentee",
    description: "Sent to a mentor when an Admin assigns them a new mentee (or reassigns one to them).",
    body: `<p class="mb-4">Dear <strong>{{mentorName}}</strong>,</p>\n<p class="mb-4">You have been assigned a new mentee under the RIQS Mentorship Programme.</p>\n<p class="mb-4"><strong>Your Mentee:</strong></p>\n<ul class="list-disc pl-5 mb-4 space-y-2">\n  <li><strong>Name:</strong> {{menteeName}}</li>\n  <li><strong>Email:</strong> {{menteeEmail}}</li>\n</ul>\n<p class="mb-4">As their assigned mentor, you are required to guide and look after their professional development, including:</p>\n<ol class="list-decimal pl-5 mb-4 space-y-2">\n  <li>Reviewing their logbook submissions and Annual Reports</li>\n  <li>Providing guidance on practical experience and professional conduct</li>\n  <li>Recommending their readiness to progress once their mentorship period is complete</li>\n</ol>\n<p class="mb-4">Please log in to your RIQS dashboard to view your mentee's progress.</p>\n<p class="mb-4">Thank you for your continued contribution to the profession.</p>\n<p class="mb-4">Best regards,<br/><strong>RIQS Mentorship Committee</strong><br/>Rwanda Institute of Quantity Surveyors</p>`,
  },
  {
    id: "suspension",
...
async function main() {
  ...
  const categoriesData = [
    ...
    { location: 'Rwandan', entityType: 'Individual', categoryName: 'Associate Quantity Surveying Technologist', categoryCode: 'AsQST', processingFee: 0.00, currency: 'RWF', firstYearFee: 70000.00, annualRenewalFee: 70000.00, stampFee: 0.00, competencyLevel: 'Level_3' },
    { location: 'Rwandan', entityType: 'Individual', categoryName: 'Associate Quantity Surveyor', categoryCode: 'AsQS', processingFee: 0.00, currency: 'RWF', firstYearFee: 100000.00, annualRenewalFee: 100000.00, stampFee: 0.00, competencyLevel: 'Level_3' },
